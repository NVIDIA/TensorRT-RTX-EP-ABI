...
REM
REM Usage:
REM   build.bat --cuda_home <PATH> --onnxruntime_home <PATH> --trt_rtx_home <PATH> [options]
REM
...
:usage
echo.
echo Usage: build.bat --cuda_home ^<PATH^> --onnxruntime_home ^<PATH^> --trt_rtx_home ^<PATH^> [options]
echo.
...
echo.
echo   Production build (with signature verification):
echo     build.bat --cuda_home "C:\CUDA" --onnxruntime_home "C:\onnx" --trt_rtx_home "C:\TRT" --production
echo.
