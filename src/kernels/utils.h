...
#define ONNX_OPERATOR_VERSIONED_KERNEL_CLASS_NAME(domain, startver, endver, name) \
    trt_rtx_ep_##name##_##domain##_ver##startver##_##endver
...
#define ONNX_OPERATOR_VERSIONED_KERNEL_EX(name, domain, startver, endver, builder, kernel_class)                 \
    ...
    template <>                                                                                                  \
    OrtStatus* BuildKernelCreateInfo<ONNX_OPERATOR_VERSIONED_KERNEL_CLASS_NAME(domain, startver, endver, name)>( \
        const char* ep_name, void* create_kernel_state, KernelCreateInfo* result)                                \
    {                                                                                                            \
        try                                                                                                      \
        {                                                                                                        \
