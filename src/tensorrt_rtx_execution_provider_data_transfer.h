...
{
    // Constructor
    TensorrtRtxDataTransfer(const ApiPtrs& api_ptrs, std::vector<const OrtMemoryDevice*>& device_mem_devices,
                            std::vector<const OrtMemoryDevice*>& shared_mem_devices, uint32_t nvidia_vendor_id);
