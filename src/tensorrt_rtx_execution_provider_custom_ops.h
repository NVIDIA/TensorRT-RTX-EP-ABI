...
inline const std::vector<const char*> kTrtCustomOpNames = {
...
struct TensorRTRtxCustomOp : Ort::CustomOpBase<TensorRTRtxCustomOp, TensorRTRtxCustomKernel> {
  ...
  bool GetVariadicInputHomogeneity() const { return false; }   // heterogeneous
  bool GetVariadicOutputHomogeneity() const { return false; }  // heterogeneous
